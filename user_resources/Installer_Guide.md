...
Both live in one place: `chartgen/shared/infrastructure/version_compatibility.csv`.
...
- Bundles `app.py`, `run_chartgen.bat`, `requirements.txt`, the full `chartgen` tree, `user_resources`, and `.streamlit`, excluding `__pycache__`
