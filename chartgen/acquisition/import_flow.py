...
from chartgen.workfile.state.workfile_file import new_manifest_row, renumber_chart_refs
from chartgen.output_generation.execution.charts.cache_reader import load_manifest
...
def process_template(tmp_pptx_path: str, cleaned_output_path: str, *,
    ...
    # percent-of-page-size sizing control (chartgen.shared.infrastructure.page_sizing).
