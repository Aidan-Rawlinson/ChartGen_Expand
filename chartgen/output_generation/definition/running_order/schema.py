...
# (chartgen.shared.infrastructure.page_sizing), never as raw EMU.
...
# chart's cut is actually resolved (chartgen.shared.infrastructure.period_ids.
...
# insert_chart time (see chartgen.shared.normalisation_containers.
