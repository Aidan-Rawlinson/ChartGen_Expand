...
from chartgen.output_generation.definition.running_order.schema import COLUMNS, SCOPE_VALUES
...
def _period_cell_to_str(value) -> str:
    ...
    actually resolved (chartgen.shared.infrastructure.period_ids.
