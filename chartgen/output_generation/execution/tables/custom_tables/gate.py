...
Mirrors chartgen.output_generation.execution.charts.custom_charts.gate for the
...
def validate_custom_table_code(code_text: str) -> str:
    ...
    """
    from chartgen.output_generation.execution.tables.custom_tables.contract import (
