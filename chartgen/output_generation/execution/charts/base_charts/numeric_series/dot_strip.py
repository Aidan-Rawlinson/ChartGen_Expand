"""Base Chart, NumericSeries. Strip plot, one dot per unit ranked left to right."""
...
def dot_strip(population_layers: list, width_emu=5486400, height_emu=2743200, tweaks=""):
