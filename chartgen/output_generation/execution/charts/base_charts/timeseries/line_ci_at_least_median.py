"""Base Chart, TimeSeries, diagnostic. Three-way circle indicator on the Selected unit's final-period value only: blue tick passes if the value is at least the scope's own median for that period, orange cross fails, grey dash if either is missing."""
