"""Base Chart, TimeSeries, diagnostic. Three-way circle indicator on the Selected unit's final-period value only. The circle is always blue; the white mark inside carries the result: a tick if the value is at most 5, a cross if not, a dash if there is no value."""
...
def line_ci_at_most_5pct(population_layers: list, width_emu=2736215, height_emu=684054, tweaks=""):
