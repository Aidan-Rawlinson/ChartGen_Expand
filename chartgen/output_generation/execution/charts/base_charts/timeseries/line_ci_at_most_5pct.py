"""Base Chart, TimeSeries, diagnostic. Three-way circle indicator on the Selected unit's final-period value only: blue tick passes if the value is at most 5, orange cross fails, grey dash if there is no value."""
