"""Base Chart, TimeSeries, diagnostic. Three-way circle indicator on the Selected unit's final-period value only. The circle is always blue; the white mark inside carries the result: a tick if the value is at least 90, a cross if not, a dash if there is no value."""
