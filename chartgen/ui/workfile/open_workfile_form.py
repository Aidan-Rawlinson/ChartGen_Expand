...
Open/Open Read-Only mechanics live in chartgen.session_shell.lifecycle.concurrency
...
from chartgen.ui.common.pickers import pick_workfile_file
from chartgen.workfile.state.session_state import clear_workfile_session_state
from chartgen.workfile.state.workfile_file import read_workfile_info
from chartgen.shared.infrastructure.version_compatibility import (
    is_file_version_compatible, get_software_id,
)
from chartgen.session_shell.lifecycle.concurrency import (
