...
chartgen.workfile.setup.save_as for the template copy, lock transfer, and save.
...
from chartgen.ui.common.pickers import pick_save_file
from chartgen.ui.tabs.charts_tab import capture_charts_sheet_state
from chartgen.ui.tabs.output_tables_tab import capture_output_tables_sheet_state
from chartgen.workfile.setup.save_as import save_as, is_same_as_original_folder
from chartgen.workfile.state.session_state import ws
...
def render_save_as_form():
    ...
    if col_save.button("Save as", type="primary", key="sa_save"):
        ...
        if errors:
            ...
            capture_output_tables_sheet_state(ws_cur)
