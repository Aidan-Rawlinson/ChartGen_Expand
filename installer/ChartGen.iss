...
; Full chartgen/ package tree and user_resources/ - "grab everything under this
...
Source: "..\chartgen\*"; DestDir: "{app}\chartgen"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "__pycache__;*.pyc"
...
; ("-- %*"), which app.py reads via chartgen.session_shell.lifecycle.startup_file
