"""
box_whisker.py
Base Chart — NumericSeries. Box and whisker plot with outliers; the
Selected unit and any peer-group layers are overlaid as markers.
...
def box_whisker(population_layers: list, width=50, height=50, tweaks=""):
