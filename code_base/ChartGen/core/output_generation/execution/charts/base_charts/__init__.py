...
timeseries), with shared palette/rendering helpers in shared.py and the
dispatch table in registry.py. This __init__ re-exports CHART_REGISTRY and
render_chart so external call sites are unaffected by the split.
"""
