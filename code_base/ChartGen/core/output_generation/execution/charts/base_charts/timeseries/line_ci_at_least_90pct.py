...
line_ci_at_most_5pct/line_ci_0/line_ci_100pct. Three-way indicator,
...
The threshold (90) is a raw value, not a fraction (e.g. 0.9) -- matches
...
"isclose" sense -- a value exactly equal to 90 is meant to pass, and
