"""
line_ci_at_most_median.py
Base Chart -- TimeSeries, diagnostic variant, one of the "CI" family
alongside line_ci_at_least_median/line_ci_at_most_2/line_ci_at_most_5pct/
...
Identical to line_ci_at_least_median except for this comparison direction.
...
def line_ci_at_most_median(population_layers: list, width_emu=2736215, height_emu=684054, tweaks=""):
